...
public class MutatedBox extends net.minecraft.client.model.ModelBox
{
    ...
    public MutatedBox(ModelRenderer renderer, int texU, int texV, BoxFactory.TextureFace[] faces, byte faceVisibilityFlag, IVec3fRead min, IVec3fRead max) {
        super(renderer, texU, texV, 0, 0, 0, 0, 0, 0, 0, false);
    ...
    public MutatedBox(ModelRenderer modelRenderer, int texU, int texV, float x, float y, float z, int width,
                      int height, int length, float inflation, boolean mirrored, byte faceVisibilityFlag) {
        super(modelRenderer, texU, texV, x, y, z, width, height, length, inflation, mirrored);
        this.faceVisibilityFlag = faceVisibilityFlag;
    }
